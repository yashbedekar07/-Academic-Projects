...
namespace OnlineShoppingCartSystem.Controllers
{
    public class OrderItemsController : Controller
    {
        ...
        public OrderItemsController(OnlineShoppingCartSystemContext context)
        {
            _context = context;
        }
        ...
        {
            var onlineShoppingCartSystemContext = _context.OrderItems.Include(o => o.Order).Include(o => o.Product);
