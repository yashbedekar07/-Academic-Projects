...
namespace OnlineShoppingCartSystem.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ReviewsController(OnlineShoppingCartSystemContext context)
        {
            _context = context;
        }
        ...
        {
            var onlineShoppingCartSystemContext = _context.Reviews.Include(r => r.Product).Include(r => r.User);
