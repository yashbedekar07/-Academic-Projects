...
namespace OnlineShoppingCartSystem.Controllers
{
    public class CartItemsController : Controller
    {
        ...
        public CartItemsController(OnlineShoppingCartSystemContext context)
        {
            _context = context;
        }
        ...
        {
            var onlineShoppingCartSystemContext = _context.CartItems.Include(c => c.Cart).Include(c => c.Product);
